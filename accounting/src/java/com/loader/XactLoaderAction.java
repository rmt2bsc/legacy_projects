 ...
 *
 */
public class XactLoaderAction extends AbstractActionHandler implements ICommand {
     ...
     * 
     */
    public XactLoaderAction() {
	super();
	logger = Logger.getLogger("XactLoaderAction");
    }
	...
	ExpenseReceiptTransLoader loader = new ExpenseReceiptTransLoader((DatabaseConnectionBean) tx.getConnector(), this.request, null);
	loader.parseDocument();
	String endDate = RMT2Date.formatDate(new Date(), "yyyy-MMM-dd HH:mm:ss");
	...
	this.logger.log(Level.INFO, "Total number of transactions evaluated: " + loader.getTransEvalCount());
	this.logger.log(Level.INFO, "Total Revenue transactions processed successfully: " + loader.getRevenueTot());
	this.logger.log(Level.INFO, "Total Expense transactions processed successfully: " + loader.getExpenseTot());
	this.logger.log(Level.INFO, "Error Count: " + loader.getErrorCount());
    }
