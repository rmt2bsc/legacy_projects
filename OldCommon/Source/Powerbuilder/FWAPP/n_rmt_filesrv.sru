$PBExportHeader$n_rmt_filesrv.sru
forward
global type n_rmt_filesrv from n_rmt_baseobject
end type
end forward

global type n_rmt_filesrv from n_rmt_baseobject
end type
global n_rmt_filesrv n_rmt_filesrv
...
public function integer of_DirList (string as_filespec, long al_filetyp, ref n_rmt_dirattrib anv_dirlist[])
...
public function integer of_sortdirlist (ref n_rmt_dirattrib anv_dirlist[], integer ai_sorttype, boolean ab_ascending)
public function integer of_sortdirlist (ref n_rmt_dirattrib anv_dirlist[], integer ai_sorttype)
public function integer of_getvolumes (ref string as_volumes[])
protected function integer of_dirattribtods (ref n_rmt_ds ads_source, n_rmt_dirattrib anv_entry, string as_sortfilename, integer ai_filegroup)
protected function integer of_dstodirattrib (ref n_rmt_ds ads_source, ref n_rmt_dirattrib anv_entry, long al_row)
...
public function integer of_DirList (string as_filespec, long al_filetyp, ref n_rmt_dirattrib anv_dirlist[]);//	Function not found in descendent
...
n_rmt_dirattrib	lnv_DirEntry, lnv_empty[]
n_rmt_ds					lds_files
...
protected function integer of_dirattribtods (ref n_rmt_ds ads_source, n_rmt_dirattrib anv_entry, string as_sortfilename, integer ai_filegroup);long	ll_row, ll_pos
string	ls_ext, ls_name
n_rmt_conversion   lnv_conv
...
protected function integer of_dstodirattrib (ref n_rmt_ds ads_source, ref n_rmt_dirattrib anv_entry, long al_row);string	ls_readonly, ls_hidden, ls_subdir, ls_archive, ls_drive, ls_system
...
on n_rmt_filesrv.create
TriggerEvent( this, "constructor" )
end on

on n_rmt_filesrv.destroy
