$PBExportHeader$n_rmt_tr.sru
$PBExportComments$Ancestor Transaction Object
forward
global type n_rmt_tr from transaction
end type
end forward

global type n_rmt_tr from transaction
end type
global n_rmt_tr n_rmt_tr
...
public function integer of_copyto (n_rmt_tr atr_target)
...
//	   (from transaction, not n_rmt_tr) were in the library search path.
//
//////////////////////////////////////////////////////////////////////////////
//
//	Copyright © 1996-1997 Sybase, Inc. and its subsidiaries.  All rights reserved.
