$PBExportHeader$n_rmt_dwsrv_sort.sru
$PBExportComments$DataWindow Sort service
forward
global type n_rmt_dwsrv_sort from n_rmt_dwsrv
end type
end forward

global type n_rmt_dwsrv_sort from n_rmt_dwsrv
event type integer ue_clicked ( integer ai_xpos,  integer ai_ypos,  long al_row,  ref dwobject adwo_obj )
event type integer ue_sortdlg ( )
end type
global n_rmt_dwsrv_sort n_rmt_dwsrv_sort
...
protected function integer of_buildsortattrib (ref n_rmt_sortattrib anv_sortattrib)
protected function integer of_parsesortattrib (string as_originalsort, ref n_rmt_sortattrib anv_sortattrib)
...
integer					li_rc
n_rmt_sortattrib		lnv_sortattrib
//n_rmt_returnattrib	lnv_return 
...
//idw_Requestor.Event ue_rowchanged() 
...
CHOOSE CASE 1 //of_GetColumnnameSource ( )
	CASE 0			
		//  Use dw Column Names
...
on n_rmt_dwsrv_sort.create
TriggerEvent( this, "constructor" )
end on

on n_rmt_dwsrv_sort.destroy
