$PBExportHeader$n_rmt_dwsrv_rowmanager.sru
$PBExportComments$DataWindow RowManager service
forward
global type n_rmt_dwsrv_rowmanager from n_rmt_dwsrv
end type
end forward

global type n_rmt_dwsrv_rowmanager from n_rmt_dwsrv
event type long ue_insertrow ( long al_beforerow )
event type long ue_addrow ( )
event type long ue_deleterow ( )
event type long ue_restorerow ( )
end type
global n_rmt_dwsrv_rowmanager n_rmt_dwsrv_rowmanager
...
public function integer of_getinfo (ref n_rmt_infoattrib anv_infoattrib)
public function integer of_getpropertyinfo (ref n_rmt_propertyattrib anv_attrib)
...
event ue_addrow;call n_rmt_dwsrv::ue_addrow;//////////////////////////////////////////////////////////////////////////////
//
//	Event:  ue_addrow
//
//	Arguments:  none
...
event ue_restorerow;call super::ue_restorerow;//////////////////////////////////////////////////////////////////////////////
//
//	Event:  ue_restorerow
//
//	Arguments:  none
...
ll_rc = of_UnDelete()
if ll_rc = -2 then
//	of_MessageBox ('ue_rowmanager_norestore', gnv_app.iapp_object.displayname, &
...
//			Added call to the dw.ue_prerestorerow event.
//
//////////////////////////////////////////////////////////////////////////////
...
////idw_requestor.Event ue_prerestorerow (lnv_restorerowattrib)
//
//// Restore rows.
...
if al_amount = 1 then
	return of_MessageBox ("ue_rowmanager_confirmsingledelete", "Confirm Delete",  &
		"Are you sure you want to delete " + is_displayitem + "?", question!, yesno!, 1)
else
	return of_messageBox ("ue_rowmanager_confirmmultipledelete","Confirm Multiple Delete", &
...
//
//////////////////////////////////////////////////////////////////////////////
n_rmt_infoattrib lnv_infoattrib
...
on n_rmt_dwsrv_rowmanager.create
call super::create
end on

on n_rmt_dwsrv_rowmanager.destroy
call super::destroy
end on
