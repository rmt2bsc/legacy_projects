...
<div id="headerLayer" class="taskHeader">
  ...
  <tr valign="top">
      <td width="36%" height="20"><img src="images/fh_case_obituary_banner.gif" width="400" height="40"></td>
      <td width="16%" height="20">&nbsp;</td>
  </tr>
</table>
</div>

<div id="menuLayer" class="taskMenu">
  <table width="100%" border="0" cellspacing="0">
    <tr valign="top">
        <td width="16%">
...
<div id="detailLayer" class="taskMenuDetail">
</div>

<div id="footerLayer" class="taskMenuFooter">
  <form name="footer">
