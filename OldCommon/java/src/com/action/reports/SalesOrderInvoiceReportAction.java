...
public class SalesOrderInvoiceReportAction extends AbstractReportAction {
	...
	private Logger logger;
       ...
       */
      public SalesOrderInvoiceReportAction(ServletContext _context, HttpServletRequest _request) throws SystemException {
          this();
     ...
     */
    protected String fetchCustomer(int id) throws ActionHandlerException {
        DataSourceApi dsApi = DataSourceFactory.create(this.dbConn);
        StringBuilder query = new StringBuilder(100);
        String data = null;

        // Build query
        query.append("select distinct customer.id customer_id,"); 
        query.append("customer.gl_account_id, ");  
   		query.append("customer.person_id, "); 
		query.append("customer.business_id, ");  
		query.append("dbo.ufn_get_customer_name(customer.person_id, customer.business_id) as name, "); 
		query.append("customer.account_no, ");
		query.append("customer.credit_limit,");
		query.append("customer.active, ");
		query.append("address.id address_id, ");
		query.append("address.addr1 address1, ");
		query.append("address.addr2 address2, ");
		query.append("address.addr3 address3, ");
		query.append("address.addr4 address4, ");
		query.append("address.zip, ");
		query.append("address.zipext, ");
		query.append("address.phone_home phone, ");
		query.append("address.phone_work, ");
		query.append("address.phone_ext, ");
		query.append("address.phone_main, ");
		query.append("address.phone_cell, ");
		query.append("address.phone_fax fax, ");
		query.append("address.phone_pager, ");
		query.append("zipcode.city, ");
		query.append("zipcode.state ");
		query.append("from customer, address, zipcode ");
		query.append("where customer.id = " + id); 
		query.append("and ((customer.person_id is not null and customer.person_id = address.person_id) or (customer.business_id is not null and customer.business_id = address.business_id)) ");
		query.append("and zipcode.zip = address.zip ");
     ...
     * @throws ActionHandlerException General database access errors
     */
    protected String fetchSalesOrder(int id) throws ActionHandlerException {
    	DataSourceApi dsApi = DataSourceFactory.create(this.dbConn);
        StringBuilder query = new StringBuilder(100);
        String data = null;
     ...
     * @throws ActionHandlerException General database access errors
     */
    protected String fetchSalesOrderItems(int id) throws ActionHandlerException {
    	DataSourceApi dsApi = DataSourceFactory.create(this.dbConn);
    	StringBuilder query = new StringBuilder(100);
        String data = null;
        ...
        query.append(" where salesorder_items.sales_order_id = ");
        query.append(id);
     ...
     * @throws ActionHandlerException General database access errors
     */
    protected String fetchTransaction(int id) throws ActionHandlerException {
    	DataSourceApi dsApi = DataSourceFactory.create(this.dbConn);
    	StringBuilder query = new StringBuilder(100);
        String data = null;

        // Build query
        query.append("select * from xact where id = ");
        query.append(id);
