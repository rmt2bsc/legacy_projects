...
public class CreditorSearchAction extends CreditorAction {
	private static final String COMMAND_NEWSEARCH = "Accounting.CreditorSearch.newsearch";
	private static final String COMMAND_SEARCH = "Accounting.CreditorSearch.search";
	private static final String COMMAND_LIST = "Accounting.CreditorSearch.list";
	private static final String COMMAND_EDIT = "Accounting.CreditorSearch.edit";
	private static final String COMMAND_ADD = "Accounting.CreditorSearch.add";
	...
	public CreditorSearchAction() {
		super();
		logger = Logger.getLogger("CreditorSearchAction");
	}
	 ...
	 */
	public CreditorSearchAction(ServletContext _context, HttpServletRequest _request) throws SystemException, DatabaseException {
