...
/**
 * Peer object that maps to the vw_account_type_category database table/view.
 *
 * @author Roy Terrell.
 */
public class VwAccountTypeCategory extends OrmBean {

/** The javabean property equivalent of database column vw_account_type_category.id */
  private int id;
/** The javabean property equivalent of database column vw_account_type_category.acct_type_id */
  private int acctTypeId;
/** The javabean property equivalent of database column vw_account_type_category.acct_cat_id */
  private int acctCatId;
/** The javabean property equivalent of database column vw_account_type_category.acct_seq */
  private int acctSeq;
/** The javabean property equivalent of database column vw_account_type_category.acct_no */
  private String acctNo;
/** The javabean property equivalent of database column vw_account_type_category.name */
  private String name;
/** The javabean property equivalent of database column vw_account_type_category.description */
  private String description;
/** The javabean property equivalent of database column vw_account_type_category.balance_type_id */
  private int balanceTypeId;
/** The javabean property equivalent of database column vw_account_type_category.acctTypeDescr */
  private String accttypedescr;
/** The javabean property equivalent of database column vw_account_type_category.acctCatgDescr */
 ...
 * @author Roy Terrell.
 */
  public VwAccountTypeCategory() throws SystemException {
  }
/**
