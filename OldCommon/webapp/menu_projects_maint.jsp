...
<form name="menuForm" method="post" action="">
  <table width="9%" border="0" bgcolor="#CCCCCC" cellpadding="0" cellspacing="0" height="15%">
    ...
    <tr> 
      <td height="41" align="center"> <a href="<%=APP_ROOT%>/reqeustProcessor/Project.TaskMaintList?clientAction=<%=ProjectConst.REQ_LIST%>" target="windowFrame"> 
          <img src="images/menuitem_proj_tasks.gif" width="60" height="35" style="border:none"></a> 
      </td>
    </tr>
    <tr>
      <td height="41" align="center"> <a href="<%=APP_ROOT%>/reqeustProcessor/Project.ProjectMaintList?clientAction=<%=ProjectConst.REQ_LIST%>" target="windowFrame"> 
          <img src="images/menuitem_proj_projects.gif" width="60" height="47" style="border:none"></a>       
      </td>
    </tr>    
    <tr>
      <td height="41" align="center"> <a href="<%=APP_ROOT%>/reqeustProcessor/Project.TimesheetList?clientAction=<%=ProjectConst.REQ_NEWSEARCH%>&<%=ProjectConst.CLIENT_DATA_MODE%>=<%=ProjectConst.TIMESHEET_MODE_EMPLOYEE%>" target="windowFrame"> 
          <img src="images/menuitem_proj_timesheet2.gif" width="60" height="45" style="border:none"></a>   
      </td>
    </tr>
    <tr>
      <td height="41" align="center"> <a href="<%=APP_ROOT%>/reqeustProcessor/Project.TimesheetList?clientAction=<%=ProjectConst.REQ_NEWSEARCH%>&<%=ProjectConst.CLIENT_DATA_MODE%>=<%=ProjectConst.TIMESHEET_MODE_MANAGER%>" target="windowFrame"> 
          <img src="images/menuitem_manage_timesheets.gif" width="63" height="59" style="border:none"></a>   
      </td>
    </tr>    
    <tr> 
      <td height="1" valign="top"> 
