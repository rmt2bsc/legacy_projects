...
<html>
  ...
  <body bgcolor="#FFFFFF" text="#000000">
    <form name="DataForm" method="POST" action="<%=APP_ROOT%>/reqeustProcessor/GeneralCodeGroup.GeneralCodeGroupEdit">
  	...
  	<br>
		...
		<table width="50%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr> 
					 ...
					 <td align="left">&nbsp;
						<beanlib:InputControl dataSource="<%=GeneralConst.REQ_ATTRIB_DATA%>" type="text" name="Description" property="Description" size="40"/>                                  
					 </td>
				</tr>
		</table>
