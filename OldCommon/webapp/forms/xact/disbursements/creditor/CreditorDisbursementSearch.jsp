...
<html>
  ...
  <%
	String pageTitle = "Disbursements Creditor/Vendor Search";
  %>
				      
  <body bgcolor="#FFFFFF" text="#000000" onLoad="initForm()">
     <h3><%=pageTitle%></h3>
 	 <form name="SearchForm" method="POST" action="<%=APP_ROOT%>/reqeustProcessor/XactDisburse.DisbursementCreditorSearch">
