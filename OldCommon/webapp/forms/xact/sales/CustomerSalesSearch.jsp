...
<html>
  <head>
    <title>Customer Sales Search Criteria</title>
  ...
  <body bgcolor="#FFFFFF" text="#000000" onLoad="initForm()">
   <form name="SearchForm" method="POST" action="<%=APP_ROOT%>/reqeustProcessor/XactSales.CustomerSalesSearch">
	     <h3><%=pageTitle%></h3>
  		 <%@include file="/forms/accounting/customer/CustomerSearchCriteriaAndList.jsp"%>
	  ...
	  <table width="100%" cellpadding="0" cellspacing="0">
		  <tr>
			<td colspan="2">
			  ...
			  <input name="<%=GeneralConst.REQ_EDIT%>" type="button" value="Edit" style="width:90" onClick="handleAction(MAIN_DETAIL_FRAME, document.SearchForm, this.name)">
    		</td>
		  </tr>		
	  </table>
