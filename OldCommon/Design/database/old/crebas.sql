...
%%   Created on:     7/27/02  10:29 AM                         
%% ============================================================

%% ============================================================
%%   Database name:  Home_System                               
%% ============================================================
dbtool create database 'Home_System.db' transaction log to 'Home_System.log';
connect to 'Home_System.db' user "dba" identified by sql;
...
%%   Index: ADDRESS_1_NDX                                      
%% ============================================================
create unique index ADDRESS_1_NDX on ADDRESS (COUNTRY_ID asc, STATE_ID asc, CITY_ID asc, ID asc, PERBUS_ID asc);
...
%%   Index: ADDRESS_3_NDX                                      
%% ============================================================
create unique index ADDRESS_3_NDX on ADDRESS (PERBUS_ID asc, ID asc, ADDRESSTYPE_ID asc);
...
alter table ADDRESS
    add foreign key PERSONAL (PERBUS_ID)
...
alter table ADDRESS
    add foreign key FK_ADDRESS_REF_2486_BUSINESS (PERBUS_ID)
