 ...
 *         &lt;element name="item" type="{}lookup_code_type"/>
 *         &lt;element name="group" type="{}lookup_code_type" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "RS_code_lookup")
public class RSCodeLookup {
    ...
    @XmlElement(required = true)
    protected LookupCodeType item;
    protected List<LookupCodeType> group;
     ...
     *     
     */
    public void setItem(LookupCodeType value) {
        this.item = value;
    }
     ...
     * 
     */
    public List<LookupCodeType> getGroup() {
        if (group == null) {
            group = new ArrayList<LookupCodeType>();
        }
        return this.group;
    }
