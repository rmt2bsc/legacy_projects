...
@XmlRootElement(name = "RQ_accounting_invoice_sales_order")
public class RQAccountingInvoiceSalesOrder {

    @XmlElement(required = true)
    protected HeaderType header;
    @XmlElement(name = "sales_order", required = true, nillable = true)
