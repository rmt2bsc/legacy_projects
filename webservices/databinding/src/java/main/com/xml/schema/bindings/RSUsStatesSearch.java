 ...
 *         &lt;element name="state_info" type="{}state_type" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "RS_us_states_search")
public class RSUsStatesSearch {
    ...
    protected List<StateType> stateInfo;
     ...
     * 
     */
    public List<StateType> getStateInfo() {
        if (stateInfo == null) {
            stateInfo = new ArrayList<StateType>();
        }
