...
public class BusinessType {
    ...
    @XmlElement(name = "entity_type", required = true, nillable = true)
    ...
    @XmlElement(name = "short_name", required = true, nillable = true)
    protected String shortName;
    @XmlElement(name = "contact_firstname", required = true, nillable = true)
    protected String contactFirstname;
    @XmlElement(name = "contact_lastname", required = true, nillable = true)
    protected String contactLastname;
    @XmlElement(name = "contact_phone", required = true, nillable = true)
    protected String contactPhone;
    @XmlElement(name = "contact_ext", required = true, nillable = true)
