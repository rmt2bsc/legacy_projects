 ...
 *         &lt;element name="contact" type="{}common_contact_type" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "RS_common_contact_search")
public class RSCommonContactSearch {
    ...
    protected List<CommonContactType> contact;
     ...
     * 
     */
    public List<CommonContactType> getContact() {
        if (contact == null) {
            contact = new ArrayList<CommonContactType>();
        }
        return this.contact;
    }
