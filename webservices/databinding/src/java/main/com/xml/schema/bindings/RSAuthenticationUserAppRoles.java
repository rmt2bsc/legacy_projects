 ...
 *         &lt;element name="role_data" type="{}user_app_roles_type"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "RS_authentication_user_app_roles")
public class RSAuthenticationUserAppRoles {

    @XmlElement(required = true)
    protected HeaderType header;
    @XmlElement(name = "reply_status", required = true)
    protected ReplyStatusType replyStatus;
    @XmlElement(name = "role_data", required = true)
    protected UserAppRolesType roleData;
     ...
     *     
     */
    public UserAppRolesType getRoleData() {
        return roleData;
    }
     ...
     *     
     */
    public void setRoleData(UserAppRolesType value) {
        this.roleData = value;
    }
