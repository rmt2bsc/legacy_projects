...
public class StateType {
    ...
    @XmlElement(name = "state_name", required = true, nillable = true)
    protected String stateName;
    @XmlElement(name = "state_code", required = true, nillable = true)
    protected String stateCode;
    @XmlElement(name = "country_id", required = true, defaultValue = "0", nillable = true)
