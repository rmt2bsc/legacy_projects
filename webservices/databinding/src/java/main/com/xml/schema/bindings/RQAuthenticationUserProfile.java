...
@XmlRootElement(name = "RQ_authentication_user_profile")
public class RQAuthenticationUserProfile {
    ...
    @XmlElement(name = "logged_in", required = true, type = Boolean.class, nillable = true)
    ...
    @XmlElement(name = "term_date", required = true, nillable = true)
    @XmlSchemaType(name = "date")
