...
import com.bean.bindings.JaxbProjectTrackerAdapter;
 ...
 * client to log in, log out, and authorize users and perform user authorization across 
 * application contexts.
 * 
 * @author RTerrell
 */
public class ProjectTrackerAuthenticator extends AbstractClientAuthentication implements UserSecurity {

    private static Logger logger =Logger.getLogger(ProjectTrackerAuthenticator.class);

    /**
     * Default constructor hat initializes the logger.
     *
     */
    public ProjectTrackerAuthenticator() {
	super();
    ...
    public Object doLogin() throws LoginException {     
        ...
        try {
            ...
            JaxbProjectTrackerAdapter.updateUserSessionType(ust, this.request);
            ...
            RMT2SessionBean sessionBean = JaxbProjectTrackerFactory.getUserSession(ust, this.request);
