 ...
 * 
 * @author RTerrell
 * @deprecated No longer needed.  Use com.project.setup.SetupImpl.java  
 *
 */
public class ProjectManagerApiImpl extends RdbmsDataSourceImpl implements ProjectQueryApi, ProjectMaintenanceApi  {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   public List getEventStatus() throws ProjectException {
			 String prevBaseClass;
			 String prevBaseView;
			 List list;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   public List findRole(String _criteria) throws ProjectException {
			 String prevBaseClass;
			 String prevBaseView;
			 List list;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   public int maintainEmployee(ProjEmployee emp) throws ProjectException {
			 int      empId;
			 if (emp == null) {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   protected int createEmployee(ProjEmployee emp) throws ProjectException {
			...
			Integer  intObj;
			 ...
			 try {
					 ...
					 this.dynaApi.addParm("id", Types.INTEGER,  emp.getEmpId(), true);
//					 this.dynaApi.addParm("person_id", Types.INTEGER,  _emp.getPersonId(), false);
					 this.dynaApi.addParm("title_id", Types.INTEGER,  emp.getEmpTitleId(), false);
					 this.dynaApi.addParm("type_id", Types.INTEGER,  emp.getEmpTypeId(), false);
					 this.dynaApi.addParm("start_date", Types.DATE,  emp.getStartDate(), false);
					 this.dynaApi.addParm("temination_date", Types.DATE,  emp.getTerminationDate(), false);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   protected int updateEmployee(ProjEmployee emp) throws ProjectException {
			String method = "updateEmployee";

			 try {
							 //  Modify employee.
					 this.dynaApi.clearParms();
					 this.dynaApi.addParm("id", Types.INTEGER,  emp.getEmpId(), false);
//					 this.dynaApi.addParm("person_id", Types.INTEGER,  _emp.getPersonId(), false);
					 this.dynaApi.addParm("title_id", Types.INTEGER,  emp.getEmpTitleId(), false);
					 this.dynaApi.addParm("type_id", Types.INTEGER,  emp.getEmpTypeId(), false);
					 this.dynaApi.addParm("start_date", Types.DATE,  emp.getStartDate(), false);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   public int maintainClient(ProjClient client) throws ProjectException {
			 ...
			 if (client.getClientId() == 0 ) {
					 clientId = this.createClient(client);
			 }
			 else {
					 clientId = this.updateClient(client);
			 }
   ...
   protected int createClient(ProjClient _client) throws ProjectException {
			...
			Integer  intObj;
			 ...
			 try {
							 //  Add client.
					 this.dynaApi.clearParms();
					 this.dynaApi.addParm("id", Types.INTEGER,  _client.getClientId(), true);
					 ...
					 if (newObj instanceof Integer) {
							 intObj = (Integer) newObj;
							 _client.setClientId(intObj.intValue());
					 }
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   protected int updateClient(ProjClient client) throws ProjectException {
			String method = "updateClient";

			 try {
							 //  Update client.
					 this.dynaApi.clearParms();
					 this.dynaApi.addParm("id", Types.INTEGER,  client.getClientId(), false);
					 //this.dynaApi.addParm("business_id", Types.INTEGER,  _client.getBusinessId(), false);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   public int maintainProject(ProjProject proj) throws ProjectException {
			 int      projId;
			 ...
			 if (proj.getProjId() == 0 ) {
					 projId = this.createProject(proj);
			 }
			 else {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   protected int createProject(ProjProject proj) throws ProjectException {
			...
			Integer  intObj;
			 ...
			 try {
							 //  Add Project.
					 this.dynaApi.clearParms();
					 this.dynaApi.addParm("id", Types.INTEGER,  proj.getProjId(), true);
					 this.dynaApi.addParm("projClientId", Types.INTEGER,  proj.getClientId(), false);
					 this.dynaApi.addParm("description", Types.VARCHAR,  proj.getDescription(), false);
					 this.dynaApi.addParm("effectiveDate", Types.DATE,  proj.getEffectiveDate(), false);
					 this.dynaApi.addParm("endDate", Types.DATE,  proj.getEndDate(), false);
					 ...
					 if (newObj instanceof Integer) {
							 intObj = (Integer) newObj;
							 proj.setProjId(intObj.intValue());
					 }
   ...
   protected int updateProject(ProjProject proj) throws ProjectException {
			String method = "updateProject";
			 ...
			 try {
							 //  Add Project.
					 this.dynaApi.clearParms();
					 this.dynaApi.addParm("id", Types.INTEGER,  proj.getProjId(), false);
					 this.dynaApi.addParm("projClientId", Types.INTEGER,  proj.getClientId(), false);
					 this.dynaApi.addParm("description", Types.VARCHAR,  proj.getDescription(), false);
					 this.dynaApi.addParm("effectiveDate", Types.DATE,  proj.getEffectiveDate(), false);
					 this.dynaApi.addParm("endDate", Types.DATE,  proj.getEndDate(), false);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   public int maintainEvent(ProjEvent event) throws ProjectException {
			 ...
			 if (event.getEventId() == 0 ) {
					 eventId = this.createEvent(event);
			 }
			 else {
					 eventId = this.updateEvent(event);
			 }
			 return eventId;
	 }
   ...
   protected int createEvent(ProjEvent event) throws ProjectException {
			...
			Integer  intObj;
			 ...
			 try {
							 //  Add Event.
					 this.dynaApi.clearParms();
					 this.dynaApi.addParm("id", Types.INTEGER,  event.getEventId(), true);
...
//					 this.dynaApi.addParm("totalHours", Types.NUMERIC,  _event.getTotalHours(), false);
					 ...
					 if (newObj instanceof Integer) {
							 intObj = (Integer) newObj;
							 event.setEventId(intObj.intValue());
					 }
   ...
   protected int updateEvent(ProjEvent event) throws ProjectException {
			String method = "updateEvent";
			 ...
			 try {
							 //  Update Event.
					 this.dynaApi.clearParms();
					 this.dynaApi.addParm("id", Types.INTEGER,  event.getEventId(), false);
//					 this.dynaApi.addParm("effectiveDate", Types.DATE,  _event.getEffectiveDate(), false);
//					 this.dynaApi.addParm("endDate", Types.DATE,  _event.getEndDate(), false);
//					 this.dynaApi.addParm("projEmployeeId", Types.INTEGER,  _event.getProjEmployeeId(), false);
//					 this.dynaApi.addParm("totalHours", Types.NUMERIC,  _event.getTotalHours(), false);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   public double calcHours(int eventId) throws ProjectException {
      ...
      Double  decObj;
			 ...
			 try {
					 ...
					 this.dynaApi.clearParms();
					 this.dynaApi.addParm("event_id", Types.INTEGER,  eventId, false);
