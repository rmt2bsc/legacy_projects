 ...
 *
 * <p>
 * When active, the print preview frame temporary replaces on-screen the text
 * component's window.
 * </p>
 * 
 * <p>
 * Keyboard shortcuts are available for zooming print preview images in and out
 * and for invoking the standard print dialog for the text component.
 * </p>
 */
public class PrintPreview {
    ...
    private static final KeyStroke PRINT_KEY = KeyStroke.getKeyStroke(
            KeyEvent.VK_P, ActionEvent.CTRL_MASK);
    private static final KeyStroke ZOOM_IN_KEY = KeyStroke.getKeyStroke(
            KeyEvent.VK_EQUALS, ActionEvent.CTRL_MASK);
    private static final KeyStroke ZOOM_OUT_KEY = KeyStroke.getKeyStroke(
            KeyEvent.VK_MINUS, ActionEvent.CTRL_MASK);
    private static final KeyStroke CLOSE_KEY = KeyStroke.getKeyStroke(
            KeyEvent.VK_W, ActionEvent.CTRL_MASK);
    private static final KeyStroke ESCAPE_KEY = KeyStroke
    ...
    private void generatePreview() {
        ...
        for (int n = 0; !Thread.currentThread().isInterrupted(); n++) {
            ...
            final Image pageImage = new BufferedImage(width, height,
        ...
        JPanel p = new JPanel() {
            ...
            public Dimension getPreferredSize() {
                ...
                if ((d.width != w) || (d.height != h)) {
                    ...
                    scaled = pageImage.getScaledInstance(d.width = w,
                            d.height = h, Image.SCALE_SMOOTH);
                    setPreferredSize(new Dimension(d.width + 2 * GAP, d.height
                            + 2 * GAP));
                }
     ...
     *
     * @param pane
     *            the text pane to generate preview for
     * @throws IllegalArgumentException
     *             if {@code pane} is {@code null}
     */
     ...
     *
     * @param scale
     *            the new scale factor for the preview images
     */
