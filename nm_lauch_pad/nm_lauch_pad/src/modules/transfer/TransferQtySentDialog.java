...
/**
 * This is a dialog for entering quantity values specifically for Transfer
 * related modules.
 * 
 * @author rterrell
 *
 */
public class TransferQtySentDialog extends GenericQtyInputDialog {

    private static final long serialVersionUID = -3700408857611961791L;

    private static final Logger logger = Logger
            .getLogger(TransferQtySentDialog.class);

    /**
     * Creates a TransferQtySentDialog initialized with its parent, size,
     ...
     */
    public TransferQtySentDialog(Window owner, Dimension size, Point pos,
