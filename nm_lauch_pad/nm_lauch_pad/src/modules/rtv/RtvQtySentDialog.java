...
/**
 * This is a dialog for entering quantity values specifically for RTV related
 * modules.
 * 
 * @author rterrell
 *
 */
public class RtvQtySentDialog extends GenericQtyInputDialog {

    private static final long serialVersionUID = -3700408857611961791L;

    private static final Logger logger = Logger
            .getLogger(RtvQtySentDialog.class);

    /**
     * Creates a RtvQtySentDialog initialized with its parent, size, position,
     * window title, and the text for the label component.
     * 
     * @param owner
     ...
     */
    public RtvQtySentDialog(Window owner, Dimension size, Point pos,
