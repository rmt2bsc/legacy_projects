 ...
 * synchronously through HTTP to using a concrete URL.
 * 
 * @author rterrell
 * 
 */
class SoapSyncTransportImpl extends AbstractSoapClientImpl implements SoapClient {

    private static Logger logger = Logger.getLogger(SoapSyncTransportImpl.class);
     ...
     * 
     */
    protected SoapSyncTransportImpl() throws SOAPException {
	super();
	return;
    }
	...
	try {
	    ...
	    SoapSyncTransportImpl.logger.log(Level.ERROR, this.msg);
