...
public class EmailMessageBean implements Serializable {
    ...
    /**
     * Creates an email attachment by using the file name of the resource.  
     * The resource should exist somewhere in the file system.
     * 
     * @param fileName
     *            The complete path and file name of the fiel system resource 
    ...
    /**
     * Creates an email attachment from streamable content that resides in memory.
     * In the event that <i>content</i> is not provided, the attachment will be 
     * created using the full path and file name passed as <i>fileName</i>, which 
     * should point to a valid file system resource.
     * 
     * @param content
     *           The actual data of the artifact that will be attached to the email.
     * @param contentType
     *           The MIME type of the content
     * @param fileName
     *            This is the file name, including full path, of the attachement when
     *            <i>content is null</i>.  If the content of the attachment is provided, 
     *            only the file name without the full path is needed since <i>fileName</i> 
     *            will serve to simply name the attachment. 
     */
