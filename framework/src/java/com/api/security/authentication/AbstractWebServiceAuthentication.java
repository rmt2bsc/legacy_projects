 ...
 */
public class AbstractWebServiceAuthentication extends RMT2Base implements UserSecurity {

    private Request request;

    private Response response;

    private static Logger logger = Logger.getLogger(AbstractWebServiceAuthentication.class);

    /**
     * Default constructor hat initializes the logger.
     *
     */
    public AbstractWebServiceAuthentication() {
        super();
    ...
    /* Added to satisfy interfacee requirement
     * (non-Javadoc)
