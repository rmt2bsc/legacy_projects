...
/**
 * Provides the option of creating a HTML lookup controleither as a Text field,
 ...
 * 
 */
public class RMT2MultiControlLookupTag extends RMT2AbstractLookupTag {
    private static final long serialVersionUID = 4038072188056879699L;
    ...
    /**
     * The driver for building text, select or radio input controls based on look up capabilities 
     * from a database implementation of the DsoApi interface.  Obtains and outputs the value from 
     * the requesting custom tag.
     * <ul>
    ...
    protected String buildSelectControlData() throws SystemException {
        ...
        try {
            ...
            throw new SystemException("Something was null in buildSelectControlData");
        }
        catch (Exception e) {
