create function getBusHourlyRate(aOrderId integer, aBusId int, aRateType int) returns numeric(11,2)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  function:    getBusHourlyRate
%  arguments:   int  aOrderId
%               int  aBusId
%               numeric  aRate
