alter function getOrderTotal(aorder_id integer) returns numeric(11,2)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   begin
     ...
     select quote_id,
       ...
       getOrderHourlyRate(aorder_id, 1),
       getOrderHourlyRate(aorder_id, 2),
...
--      end if;
      ...
      set hourlycost = hourly_rate + ext_hourly_rate;
