$PBExportHeader$n_rmt_platform.sru
$PBExportComments$Cross Platform service
forward
global type n_rmt_platform from n_rmt_baseobject
end type
end forward

global type n_rmt_platform from n_rmt_baseobject
end type
global n_rmt_platform n_rmt_platform
...
public function long of_printdlg (ref str_printdlgattrib astr_printdlg, window aw_obj)
public function long of_pagesetupdlg (ref str_pagesetupattrib astr_pagesetup)
...
on n_rmt_platform.create
TriggerEvent( this, "constructor" )
end on

on n_rmt_platform.destroy
