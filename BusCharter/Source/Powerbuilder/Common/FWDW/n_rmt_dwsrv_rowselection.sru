$PBExportHeader$n_rmt_dwsrv_rowselection.sru
$PBExportComments$DataWindow Row Selection service
forward
global type n_rmt_dwsrv_rowselection from n_rmt_dwsrv
end type
end forward
...
global n_rmt_dwsrv_rowselection n_rmt_dwsrv_rowselection
...
event ue_lbuttondown;call n_rmt_dwsrv::ue_lbuttondown;//////////////////////////////////////////////////////////////////////////////
//
//	Event:  ue_lbuttondown
//
//	(Arguments:
//	aul_flags: passed from lbuttondown event in u_rmt_dw
//	ai_xpos: x-position of the mouse passed from lbuttondown event in u_rmt_dw
// ai_ypos: y-position of the mouse passed from lbuttondown event in ue_u_dw
//
//	(Returns:  None)
//
...
event ue_rbuttonup;call super::ue_rbuttonup;//////////////////////////////////////////////////////////////////////////////
//
//	Event:  ue_rbuttonup
//
//	(Arguments:
...
event ue_rbuttondown;call super::ue_rbuttondown;//////////////////////////////////////////////////////////////////////////////
//
...
event ue_rowfocuschanged;call super::ue_rowfocuschanged;//////////////////////////////////////////////////////////////////////////////
//
...
on n_rmt_dwsrv_rowselection.create
TriggerEvent( this, "constructor" )
end on

on n_rmt_dwsrv_rowselection.destroy
