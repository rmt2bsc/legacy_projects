$PBExportHeader$n_rmt_winsrv.sru
$PBExportComments$Base Window service
forward
global type n_rmt_winsrv from n_rmt_baseobject
end type
end forward

global type n_rmt_winsrv from n_rmt_baseobject
end type
global n_rmt_winsrv n_rmt_winsrv

type variables
Protected:
w_rmt_ancestor		iw_requestor
end variables
...
on n_rmt_winsrv.create
TriggerEvent( this, "constructor" )
end on

on n_rmt_winsrv.destroy
