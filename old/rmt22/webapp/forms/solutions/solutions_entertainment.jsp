...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
	<title>Entertainment Solutions</title>
								...
								<td style="width:766px;"><table border="0" cellpadding="0" cellspacing="0" style="width:766px;">
									<tr>
										<td style="height:226px; width:766px;"><table border="0" cellpadding="0" cellspacing="0" style="margin:31px 0 0 25px; width:712px;">
                                          <tr>
                                            <td><img alt=""  src="../../images/title_solutions_entertainment.gif" style="margin-bottom:9px;"></td>
                                          </tr>
                                          <tr>
                                            <td class="ins" style="line-height:13px;">
      <p><font class="blocktext">Our custom planning solutions for the hospitality industry help you collaborate, track performance to budget, and stay 
	  accountable for revenue.&nbsp;&nbsp;Your business has company-wide planning needs as well as specific requirements for each hotel, club, 
	  restaurant, and casino.&nbsp;&nbsp;But how do you manage them all? Our custom planning solutions for the hospitality industry help you 
	  collaborate, track performance to budget, and stay accountable.</font></p>
