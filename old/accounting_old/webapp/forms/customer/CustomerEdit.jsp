...
<table width="90%" border="0">
	...
	<tr> 
		...
		<td width="81%">
			  ...
			  <beanlib:InputControl type="hidden" name="AccountNo" value="#customer.AccountNo"/>
	...
	<tr> 
		...
		<td width="81%">
		  <beanlib:InputControl type="text" name="CreditLimit" value="#customer.CreditLimit" tabIndex="1"/>
		</td>									 
	</tr>				
	<tr> 
		<td width="19%"  class="clsTableFormHeader"> 
		...
		<td width="81%">
		   <beanlib:InputControl type="text" name="Description" value="#customer.Description" tabIndex="2"/>
		</td>									 
	</tr>				
</table>