...
//    protected int curLevel; // Level of directory structure.  Root=1, Artist=2, Album=3, Disc=4
...
//	this.curLevel = 0;
     ...
     */
    protected MediaBean extractFileData(File sourceFile) throws AudioVideoException {
	String value;
	String msg;
	long ms;
	int hr;
...
//	    }
	...
	if (proj.getArtistId() <= 0) {
	    ...
	    throw new UndetermineArtistException(this.msg);
	}
	...
	if (proj.getProjectTypeId() < 1 || proj.getProjectTypeId() > 2) {
	    ...
	    logger.log(Level.WARN, this.msg);
	    throw new UndetermineProjectTypeException(this.msg);
	}
	...
	if (proj == null) {
	    ...
	    throw new AudioVideoException(this.msg);
	}
