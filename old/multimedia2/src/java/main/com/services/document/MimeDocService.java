 ...
 *
 */
public class MimeDocService extends AbstractSoapServiceProcessor {
     ...
     *
     */
    protected MimeDocService() {
	super();
    }

    public MimeDocService(DatabaseConnectionBean con, Request request) {
	super(con, request);
    }
	...
	String xml = null;
	this.reqMessage = (RQContentSearch) reqParms.get(SoapProductBuilder.PAYLOADINSTANCE);
	...
	try {
	    ...
	    this.outAttachments = new ArrayList<Object>();
	    outAttachments.add(dh);
