...
public class UserAuthenticationException extends RMT2Exception {
	 ...
	 *            The integer code.
	 */
	public UserAuthenticationException(String msg, int code) {
		super(msg, code);
	}
	 ...
	 *            template message.
	 */
	public UserAuthenticationException(Object _con, int _code, ArrayList _args) {
