 ...
 * @author RTerrell
 */
public class CopyOfProjectTrackerAuthenticator extends RMT2Base implements UserSecurity {

    private Request request;

    private Response response;

    private static Logger logger =Logger.getLogger(CopyOfProjectTrackerAuthenticator.class);

    /**
     * Default constructor hat initializes the logger.
     *
     */
    public CopyOfProjectTrackerAuthenticator() {
	super();
