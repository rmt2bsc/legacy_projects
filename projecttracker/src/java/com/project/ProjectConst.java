...
public class ProjectConst {
    ...
    public static final String PROJPARMS = "ProjectParms";
    ...
    public static final String REQ_PRINT = "printtimesheetdetails";

    /** Print Timesheet Details action code */
    public static final String REQ_PRINTSUMMARY = "printtimesheetsummary";
    
    /** Email Timesheet Details action code */
    public static final String REQ_EMAILSUMMARY = "emailtimesheetsummary";
    ...
    /** Request attribute name mapping to a client */
    public static final String CLIENT_DATA_CLIENT = "client";

    /** Request attribute name mapping to a list of projects */
    public static final String CLIENT_DATA_PROJECTS = "list";

    /** Request attribute name mapping to a project */
    public static final String CLIENT_DATA_PROJECT = "project";

    /** Request attribute name mapping to a task */
    public static final String CLIENT_DATA_TASK = "task";

    /** Request attribute name mapping to a list of tasks */
    public static final String CLIENT_DATA_TASKS = "list";
    ...
    /** Request attribute mapping for client timesheet summary by status */
    public static final String CLIENT_DATA_CLIENT_TS_SUM = "clienttimesheetsummary";
